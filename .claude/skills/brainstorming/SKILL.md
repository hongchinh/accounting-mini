---
name: brainstorming
description: Explore approaches and validate design before committing to implementation. Proposes 2-3 options with trade-offs.
---
...
### 3.5. Visual Companion (tùy chọn)

Khi câu hỏi mang tính visual (layout, UI mockup, diagram, side-by-side comparison),
dùng Visual Companion thay vì mô tả bằng chữ.

Xem hướng dẫn đầy đủ tại: `.claude/skills/brainstorming/visual-companion.md`

**Quick start:**
```powershell
.\scripts\Start-BrainstormServer.ps1
# Capture JSON output → lưu screen_dir + state_dir
# Bảo user mở URL trong browser
# Viết HTML vào screen_dir bằng Write tool
```

**Khi nào dùng browser vs terminal:**
| Dùng browser | Dùng terminal |
|---|---|
| UI mockups, wireframes | Requirements, scope questions |
| Layout comparisons | A/B/C conceptual choices |
| Architecture diagrams | Tradeoff lists, pros/cons |
| Design polish questions | Technical decisions (API, schema) |
