...
4. `docs/code-standard/` — coding conventions, naming rules, style guides, environment setup, custom rules and patterns the team follows. Focus on _how to write code that fits in with the existing codebase_, best practices, and team conventions.
...
Contains project overview and file tables for each documentation section. Example structure:
...
| File | Description |
|------|-------------|
| [components.md](architecture/components.md) | Component interactions and data flow |

## Codebase
| File | Description |
|------|-------------|
| [structure.md](codebase/structure.md) | Directory layout and entry points |
...
- Ask targeted questions via `AskUserQuestion` when information cannot be reliably inferred (business goals, ambiguous module ownership, conflicting conventions, unclear architecture decisions).
