...
| P5-A2 | 5 | Assumption | `format.ts` utility assumed to handle Vietnamese locale for money formatting (TotalDebtAmount, TotalCreditAmount). | codebase inspection | No | Open |  | Verify formatting output in Phase 8/Phase 9. |
